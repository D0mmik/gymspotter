...
export function PhotoDrawer({open, onOpenChange, selectedGym}: PhotoDrawerProps) {
                    ...
                    <DrawerHeader className="text-left">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-lg bg-red-500/20 border border-red-500/30">
                    ...
                    <div className="px-4 pb-8">
                        {form.formState.isSubmitted ? (
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                <div
                                    className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-green-500/20 flex items-center justify-center mb-4">
                                ...
                                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    {previewUrl ? (
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            >
                                                <div
                                                    className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-zinc-800 group-hover:bg-red-500/20 flex items-center justify-center transition-colors">
                                                    <ImagePlus
                                                        className="w-7 h-7 md:w-8 md:h-8 text-zinc-500 group-hover:text-red-500 transition-colors"/>
                                                </div>
                                                <span
                                                    className="text-zinc-400 group-hover:text-white transition-colors font-medium">
                        {t('selectPhoto')}
                      </span>
                                            </Button>
