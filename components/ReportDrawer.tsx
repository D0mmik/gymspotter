...
export function ReportDrawer({open, onOpenChange, selectedGym}: ReportDrawerProps) {
                    ...
                    <DrawerHeader className="text-left">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div
                                    className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-lg bg-amber-500/20 border border-amber-500/30">
