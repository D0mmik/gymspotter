...
import { PhotoDrawer } from "@/components/forms/PhotoDrawer";
import { ReportDrawer } from "@/components/forms/ReportDrawer";
import { EquipmentDrawer } from "@/components/forms/EquipmentDrawer";
          ...
          <div className="mx-auto w-full max-w-lg flex flex-col h-full overflow-hidden">
            ...
            <div className="px-4 pb-6 md:pb-8 overflow-y-auto flex-1">
              <Photos
                ...
                handlePhotoDrawerOpen={() => setPhotoDrawerOpen(true)}
              />
              <OpeningHoursInfo openingHours={selectedGym.openingHours} />
              <EquipmentInfo
                selectedGym={selectedGym}
                onOpenChange={() => setEquipmentDrawerOpen(true)}
              />
